...
describe('LoginPage Component', () => {
  ...
  test('shows success message when login is successful', async () => {
    ...
    expect(screen.getByText('Login successful!').className).toContain('success-message');
  ...
  test('shows error message when login fails', async () => {
    ...
    // Check message styling
    expect(screen.getByText('Invalid email or password. Please try again.').className).toContain('error-message');
